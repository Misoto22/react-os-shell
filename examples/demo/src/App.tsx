...
// v3.4.0 — UI primitives gallery + page-template switcher.
const PrimitivesDemo = lazy(() => import('./PrimitivesDemo'));
const TemplatesDemo = lazy(() => import('./TemplatesDemo'));
...
const winStyle = (name: string) =>
  lazy(() => import('./WindowStylesDemo').then(m => ({ default: (m as any)[name] })));
...
setShellWindowRegistry(createWindowRegistry(bundledApps, {
  ...
  // Window-style showcase: a launcher plus one route per chrome variant.
  '/windows-demo': {
    component: WindowStylesDemo,
    label: 'Window Styles',
    size: 'lg',
  },
  ...
  '/templates-demo': { component: TemplatesDemo, label: 'Page Templates', size: '2xl', flushBody: true },
...
const NAV_ICONS: Record<string, JSX.Element> = {
  ...
  '/templates-demo': path('M3.75 6A2.25 2.25 0 016 3.75h12A2.25 2.25 0 0120.25 6v12A2.25 2.25 0 0118 20.25H6A2.25 2.25 0 013.75 18V6zM3.75 9h16.5M9 9v11.25'),
};
